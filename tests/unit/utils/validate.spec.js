...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/wangtao/vue-element-admin')).toBe(true)
    expect(validURL('http://github.com/wangtao/vue-element-admin')).toBe(true)
    expect(validURL('github.com/wangtao/vue-element-admin')).toBe(false)
  })
  it('validLowerCase', () => {
